...
def parse_args():
    ...
    parser.add_argument('--model_type', type=str, default='CRNN', choices=['CRNN', 'Wavenet'],  help='Model architecture, Conv RNN, or Wavenet')
...
def main(args):
    ...
    wake = WakewordTrigger(model_dir=args.models_dir, model_type=args.model_type)
